        ...
        <section className="links" aria-label="Links principais">
          <a className="btn btn-vip" href="https://pay.hub.la/ywXFtk22i37lqjVmNzvf" target="_blank" rel="noopener noreferrer">
            <div className="btn-left">
              ...
              <div className="btn-info">
                <span className="btn-title">Canal VIP</span>
                <small>Acesso exclusivo</small>
              </div>
            </div>
          ...
          <a className="btn btn-telegram" href="https://t.me/+Ji9nUual2LJmMDE5" target="_blank" rel="noopener noreferrer">
            <div className="btn-left">
              ...
              <div className="btn-info">
                <span className="btn-title">Acessar Grupo FREE</span>
          ...
          <a className="btn btn-suporte" href="https://t.me/tipssuporte" target="_blank" rel="noopener noreferrer">
            <div className="btn-left">
              ...
              <div className="btn-info">
                <span className="btn-title">Fale com o Suporte</span>
                <small>Suporte</small>
              </div>
            </div>
            <span className="btn-arrow">→</span>
